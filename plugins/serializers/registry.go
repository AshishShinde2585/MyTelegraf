...
import (
	...
	"github.com/influxdata/telegraf/plugins/serializers/test"  // register your serializer
...
func NewSerializer(config *Config) (Serializer, error) {
	...
	// TEST : Create serializer : This is just one way of implementation
	// you can simply call function from test.go = test.NewSerializer()
	case "test":
		serializer, err = NewTestSerializer(config.Prefix)
...
// TEST : it is just a way of implementation


func NewTestSerializer(prefix string) (Serializer, error) {
	return test.NewSerializer(prefix)
}
